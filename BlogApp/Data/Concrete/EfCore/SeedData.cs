            ...
            if(context != null)
            {
                ...
                if(!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "ferhatsimsek", Name = "Ferhat Şimşek", Email = "info@ferhatsimsek.com", Password="123456", Image = "p1.jpg"},
                        new User { UserName = "arslansimsek", Name = "Arslan Şimşek", Email = "info@arslansimsek.com", Password="123456", Image = "p2.jpg"}
                    );
                    context.SaveChanges();
                }
